        ...
        <div class="lb-wrap">
            ...
            <div class="podium">
                <div class="podium-card podium-card--2">
                    ...
                    <div class="podium-name">{{ optional($topScores[1]->user)->pseudo ?? '—' }}</div>
                ...
                <div class="podium-card podium-card--1">
                    ...
                    <div class="podium-avatar">🥇</div>
                    <div class="podium-name">{{ optional($topScores[0]->user)->pseudo ?? '—' }}</div>
                ...
                <div class="podium-card podium-card--3">
                    <div class="podium-avatar">🥉</div>
                    <div class="podium-name">{{ optional($topScores[2]->user)->pseudo ?? '—' }}</div>
